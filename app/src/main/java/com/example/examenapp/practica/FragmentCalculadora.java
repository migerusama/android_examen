            ...
            switch (view.getId()) {
                case R.id.bAreaCubo:
                    ...
                    if (lCubo.getText().toString().isEmpty())
                        ...
                        throw new com.example.examenapp.practica.NumericException("Debe introducir un numero");
                    else {
                        lcubo = Double.parseDouble(lCubo.getText().toString());
                        //Comprobación dato es menor o igual a cero
                        if (lcubo <= 0) throw new com.example.examenapp.practica.NumericException("El valor debe ser mayor a 0");
                ...
                case R.id.bAreaEsfera:
                    ...
                    if (radio.getText().toString().isEmpty())
                        ...
                        //Comprobación dato es menor o igual a cero
                        if (Radio <= 0) throw new com.example.examenapp.practica.NumericException("El valor debe ser mayor a 0");
                        else
                ...
                case R.id.bAreaPara:
                    ...
                    if (largo.getText().toString().isEmpty() || ancho.getText().toString().isEmpty())
                        //Lanzar excepción personalizada
                        throw new com.example.examenapp.practica.NumericException("Debe introducir valores");
                    else {
                        ...
                        if (Largo <= 0 || Ancho <= 0 || Profundo <= 0)
                            ...
                            tvResultadoPara.setText("Resultado: " + 4 * (Largo * Ancho) + 2 * (Ancho * Profundo));
                    }
                    break;
